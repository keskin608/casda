...
{
    [SerializeField] KeyCode SetCameraKey = KeyCode.C;                              //Set next camera on PC hotkey.
    ...
    Vector3 TargetPoint
    {
        get
        {
            ...
            result += TargetCar.transform.position; // Y eksenini sıfırlamadan arabanın pozisyonunu kullanıyoruz
            return result;
        }
    }
    ...
    class CameraPreset
    {
        public Transform CameraHolder;                  //Parent of the camera.
